...
"""The number of integers which has exactly x divisors in python can be found by using the function which counts the number of divisors of a number and then checking if it is equal to x."""
