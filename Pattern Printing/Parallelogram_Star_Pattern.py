#Parallelogram Star Pattern in python ?
"""In this pattern, number of rows and numbers of columns are different. Then, User have to enter two value, in which one value will be determine as a number of rows and other value will be considered as columns of the pattern. With the help of “For-Loop” and “Nested For Loop” we will print Parallelogram Star Pattern."""
